...
wx_dir = "C:/Users/29507/Documents/WeChat Files/wxid_orm4qb51u61j21"
def get_image_ex(path, base_path) -> str:
    if path:
        base_path = os.path.join(os.getcwd(),base_path)
        output_path = decode_dat(os.path.join(wx_dir, path), base_path)
